...
* **(ii)** For any rational subset $U \subset X$ with tilt $U^{\flat} \subset X^{\flat}$, the complete affinoid $K$-algebra $(\mathcal{O}_X(U), \mathcal{O}_X^+(U))$
*  is perfectoid, with tilt $(\mathcal{O}_{X^{\flat}}(U^{\flat}),
*   \mathcal{O}_{X^{\flat}}^+(U^{\flat}))$.
* **(iii)** The presheaves $\mathcal{O}_X,
* \mathcal{O}_{X^{\flat}}$ are sheaves.
